...
/**
 * Performance test to assure that 1st 50000 fibonacci numbers are
 * getting calculated correct in less than 2 seconds
 * (actually, 0.7 seconds is average for this test)
 * <p>
 * NOTICE: full sequence is NOT printer out here, only 5000th number
 * </p>
 * @author Ilya Afanasiev (ilya.afanasiev@gmail.com)
 */
public class PerfCheck50K implements IPerfTest {
	
	private static final String REF_FNAME   = "50000.txt";
	...
	public boolean isPerfOk() {
		// NOTE: this test calculates the whole Fibonacci sequence starting from 1 till 50000,
		// so 2 seconds should be quite acceptable for this amount of calculations
		return runTimeMs < 2000;
	}
	...
	public static void main(String[] args) throws Exception {
		PerfCheck50K test = new PerfCheck50K();
